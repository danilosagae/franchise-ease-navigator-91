      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3 text-base md:text-lg text-gray-700 mb-6">
            <p>
              Quanto mais você pesquisa, mais dúvidas aparecem: e se eu escolher a franquia errada? E se o ponto não der certo?
            </p>
            <p>
          ...
          <div className="bg-white p-5 rounded-lg shadow-md border-l-4 border-brand-blue">
